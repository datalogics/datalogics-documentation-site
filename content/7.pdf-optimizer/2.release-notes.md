...
## Version 3.5.7 (December 19, 2025)

**New Features:**

- PDFChecker Installer Improvements

**Problem Corrections:**

- SF#46646 - Warning Message in Latest PROD Version 3.5.4: "discard-external-crossreferences"
- SF#47046 - Signature Lost After PDF Optimization
- SF#47208 - PDF Optimizer User Guide PDF doesn't include mention of TDM metadata (K)
- SF#47238 - PDF Optimizer conversion to PDF/A is failing
- SF#47291 - PDF Optimizer: Missing text segments

## Version 3.5.6 (September 15, 2025)
...
- Corrects an error where an already-optimally compressed file that couldn't be reduced in size would fail to raise an error as expected. 
- Corrects a Performance issue that could occur using the compressionMedium profile
