...
description: Please note that the Adobe PDF Converter was formerly known as Adobe Normalizer.
navtitle: PDF Converter Release Notes
---

## PDF Converter v3.2PlusP1n (February 27, 2026)

Changes:

- SF#47211 / SF#47343 – Updates expat to version 2.7.4 to mitigate vulnerabilities.
- SF#47338 / SF#47387 – Updates libpng to 1.6.55 to mitigate vulnerabilities.

Problem Corrections:

- SF#46437 – Corrects an instance the JPEG2K encoder produced corrupted output.
- SF#47035 – Corrects an issue where the library fails to detect a rectangle, causing one of the lines to appear bolder at different zoom levels.
