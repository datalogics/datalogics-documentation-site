...
### ***Attention!*** You can also find sample code on [GitHub](https://github.com/datalogics/apdfl-cplusplus-samples) [GitHub](https://github.com/datalogics/apdfl-cplusplus-samples).
