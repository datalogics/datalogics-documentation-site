...
1. Search for “Datalogics” and choose **Adobe.PDF.Library.LM.NET**
2. Install in your project
3. Accept license terms (we promise not to take your kids or pets)
4. Adobe PDF Library is now added
...
The latest version of the .NET API reference is available [HERE](https://docs.datalogics.com/apdfl/DotNet)
