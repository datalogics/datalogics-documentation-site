...
* SF#46817 – The page rendering flag kPDPageSwapComponents used in conjunction with the DeviceCMYK colorspace will render as KYMC.
  - The page rendering flag kPDPageInvertedGrayscale has been added to support Inverted Grayscale rendering.
...
- SF#46676
  - A problem converting U3D annotations during PDF/A-4e has been corrected.
  - PDF/A conversion has been improved to support preserving Widget Annotations, previously they were Flattened into Page Content.
  - Annotation preservation during PDF/A conversion has been improved in general.
- SF#46712 – Corrects a problem subsetting already-subset TrueType fonts in some scenarios.
- SF#46773
  - Corrects a small memory leak in the Creation of Redaction Annotations.
  - Corrects an issue where WordFinder usage could lead to memory corruption in some cases.
...
- SF#46617 – The PDDoc parameter has been removed from the following functions as it was not functional in practice\* DLCreatePDEImageFromFile
...
- Added C++ Image APIs:\* DLCreatePDEImagesFromTIFF() to create PDEImage's from a multipage TIFF
...
- Adds new Text Extraction samples in C++, .NET Framework, and .NET demonstrating text extraction:\* From annotations.
