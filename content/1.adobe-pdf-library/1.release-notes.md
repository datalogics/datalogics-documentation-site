...
- Add support for PAdES (B-T) baseline electronic signatures to .NET/Java interfaces.

  This enhancement enables creation and validation of signatures that include trusted timestamps, ensuring long-term integrity and compliance with ETSI PAdES baseline standards.

- Add support for PAdES-EPES policy-based electronic signatures to .NET/Java interfaces.

  This enhancement enables signatures to include an explicit signature policy identifier, ensuring that signing operations adhere to defined organizational or regulatory requirements.
...
- API updates to facilitate generation of ETSI PAdES-EPES (policy-based) signatures.

  This allows developers to define and include signature policy identifiers and associated policy information during signature creation, in compliance with ETSI PAdES specifications.
...
- API updates to facilitate generation of PAdES BES (B-T) signatures.

  Added support for PAdES B-T baseline signatures via a new API implementing the PAdES signature class for PDF documents.
