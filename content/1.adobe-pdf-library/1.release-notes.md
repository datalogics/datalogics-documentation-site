...
- Removes the Java Documentation from the installer.
- Removes the .NET Framework Documentation from the installer.
- Removes the .NET Documentation from the installer, it can now be found on the website.
