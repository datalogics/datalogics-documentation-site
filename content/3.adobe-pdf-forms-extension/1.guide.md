...
Forms Extension is an add-on module for Adobe PDF Library and its API information can be found [HERE](https://docs.datalogics.com/apdfl18/CPlusPlus/APDFL18.0.5PlusP1p/formsextension_General.html).
